...
def non_conv_experiment(eta, omegas = [1.5, 1.55, 1.6, 1.65, 1.7, 1.75, 1.8, 1.85, 1.9, 1.95, 2],
                        num_runs = 100,  file='../data/opt_omega'):
    """
...
def plot_non_conv(file='../data/opt_omega.npz', num_runs=20, plot_file=None):
    """
...
if __name__ == '__main__':
    ...
    num_runs=100
    for eta in etas:
        filename = '../data/opt_omega' + str(eta) + '.npz'
        plot_file_name = '../results/diffusion_limited_aggregation/opt_omega' + str(eta) + '.png'
