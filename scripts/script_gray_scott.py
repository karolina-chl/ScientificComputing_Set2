...
def time_evolution(total_time):
    ...
    last_frame_gray_scott_save(chemical_V, f"figures/figures_final/, {chemical_simulated}, {total_time}, f_{U_supply}, k_{k}.png")

def changing_parameters(U_supply, k):
    ...
    solve_gray_scott(chemical_U, chemical_V, total_time, time_step_size, x_length, n_steps, diffusion_coefficient_u, diffusion_coefficient_v, U_supply, k)
    #plot_animation(chemical_V)
    last_frame_gray_scott_save(chemical_V, f"figures/figures_final/{chemical_simulated}, f_{U_supply}, k_{k}.png")
...
def script_gray_scott_noise(noise_boundry):
    x_length = 100
    n_steps = 100
    total_time = 5000
    time_step_size = 1
    ...
    last_frame_gray_scott_save(chemical_V, f"figures/figures_final/ {noise_boundry}, f_{U_supply}, k_{k}.png")
...
def script_gray_scott(total_time, noise_boundry, U_supply, k):
    ...
    chemical_U, chemical_V = init_grids(total_time, time_step_size, n_steps)
    solve_gray_scott(chemical_U, chemical_V, total_time, time_step_size, x_length, n_steps, diffusion_coefficient_u, diffusion_coefficient_v, U_supply, k, noise_boundry)
    last_frame_gray_scott_save(chemical_V, f"results/ {total_time}, {noise_boundry}, f_{U_supply}, k_{k}.png")
...
if __name__ == "__main__":
    ...
    #     changing_parameters(U_supply, k)

    # noise = [0.001, 0.01, 0.02, 0.1]     
    # for noise_boundry in (noise):
    #     script_gray_scott_noise(noise_boundry)
